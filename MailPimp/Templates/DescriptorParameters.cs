...
namespace MailPimp.Templates
{
	public class DescriptorParameters
	{
		...
		public DescriptorParameters(string viewPath, string viewName,
			string masterName, bool findDefaultMaster, KeyValueDictionary extra)
		{
